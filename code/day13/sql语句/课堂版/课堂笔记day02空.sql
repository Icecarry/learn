...
-- 条件查询
	...
	-- 模糊查询(where name like 要查询的数据)
		...
		select * from students where name like 2'_';
	...
	-- 范围查询
		...
		select * from students where age in (18,34,56,100,23,12);
		...
		-- 查询 年龄在18到34之间的的信息
		select * from students where age between 16 and 24;
...
-- 聚合函数
	...
	select sum(age)/count(*) as avg_age from students;
